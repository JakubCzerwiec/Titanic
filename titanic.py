...
print(result[0]['probabilities'][1]) # print what the trained model predict (probabilities on index 0 = died probability, on index 1 survival probability) for person on index 